...
export default {
    ...
    actions: {
        ...
        async fetchData(ctx) {
            ...
            if (this.state.filter.currentCurrency) {
                params = {from: this.state.filter.currentCurrency, ...params};
            }
            if (this.state.filter.selectedCurrency) {
                params = {to: this.state.filter.selectedCurrency.join(","), ...params};
            }
